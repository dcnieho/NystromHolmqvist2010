...
%%% begin)
% drift amplitude - TODO replace with cosine rule
data.fixation.driftAmplitude ...
    = hypot(...
            data.deg.X(data.fixation.off) - data.deg.X(data.fixation.on), ...
            data.deg.Y(data.fixation.off) - data.deg.Y(data.fixation.on)  ...
           ).';

% drift direction
data.fixation.driftDirection ...
    = atan2(...
            data.deg.Y(data.fixation.off) - data.deg.Y(data.fixation.on), ...
            data.deg.X(data.fixation.off) - data.deg.X(data.fixation.on)  ...
           ).';
