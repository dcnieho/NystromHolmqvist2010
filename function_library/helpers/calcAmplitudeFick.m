...
if nargout==2
    ...
    % this is (numerically, dunno about the math) equivalent to getting the
    % direction perpendicular to the rotation axis between these two
    % points:
    % axis = cross([x1./z1 y1./z1 ones(size(x1))],[x2./z2 y2./z2 ones(size(x2))]);
    % dir = atan2(axis(:,2),axis(:,1))*180/pi+90
    % (NB: still some wraparound and such, and maybe not +90...
end
