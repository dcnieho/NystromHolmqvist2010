...
if isempty(data.(fieldname).on)
    [data.(fieldname).duration,...
     data.(fieldname).startPointAzi,...
     data.(fieldname).startPointEle,...
     data.(fieldname).endPointAzi,...
     data.(fieldname).endPointEle,...
     data.(fieldname).amplitude,...
     data.(fieldname).direction,...
     data.(fieldname).peakVelocity,...
     data.(fieldname).peakAcceleration] = deal(0);
    return;
end
