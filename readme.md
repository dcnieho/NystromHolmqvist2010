...
First, the internals of the algorithm have been rewritten extensively with an eye on increasing performance. Furthermore, quite a few additions have been made. This is a non-exhaustive list:
  ...
  - option to detrend the gaze velocity data by median filtering it and then subtracting the output of this median filter.
  ...
  - option to determine saccade onset by fitting straight line to accelerating flank of velocity profile of saccade, and seeing where this line intersects with vel==0. This works well with low-sampling frequency data.
